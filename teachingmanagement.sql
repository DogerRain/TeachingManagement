/*
 ...
 Source Schema         : teachingmanagement

 Target Server Type    : MySQL
 Target Server Version : 50562
 File Encoding         : 65001

 Date: 28/07/2020 01:05:35
*/
...
CREATE TABLE `newsinfo`  (
  ...
  `ntitle` text CHARACTER SET utf8 COLLATE utf8_general_ci,
  `ncontent` longtext CHARACTER SET utf8 COLLATE utf8_general_ci,
  `nauthor` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `ntime` datetime DEFAULT NULL,
  `nimg` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
